...
class ComprehensivePositionAnalyzer:
    ...
    def run_comprehensive_analysis(self, signals_file, max_signals=100):
        """Run comprehensive analysis on signals (limited for testing)"""
        ...
        print(f"Analyzing {len(signals_df)} signals (limited for testing)...")
...
if __name__ == "__main__":
    ...
    # Start with 100 signals for testing
    results = analyzer.run_comprehensive_analysis('Backtest Monthly HA and MACD', max_signals=100)
